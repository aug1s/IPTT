				 ...
				 if ( is_active_sidebar( 'photograph_footer_options' ) ) :
					...
					<div class="copyright">
						<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
									<?php esc_html_e('Autorių teisės:','photograph'); ?> <a title="<?php echo esc_attr__( 'Viktorija Palioniene', 'photograph' ); ?>" target="_blank" href="<?php echo esc_url( 'https://www.facebook.com/Viktorija-Palionienė-Photography-108639374815919' ); ?>"><?php esc_html_e('Viktorija Palioniene','photograph');?>
						<?php
